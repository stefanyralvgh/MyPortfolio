...
const AdventurePage: React.FC = () => {
  ...
  const handleLevelComplete = () => {
    setCompletedLevels(
      (prev) => new Set(Array.from(prev).concat(currentLevel))
    );
        ...
        <>
          <div className="finale-container">
            <div className="finale-content">
              ...
              <p className="finale-message">{t("adventure.finale.message")}</p>
              <div className="finale-stats">
                <div className="stat">
                  <span className="stat-number">{dbLevels.length}</span>
                  <span className="stat-label">
                    {t("adventure.stats.completed")}
                  </span>
                </div>
                <div className="stat">
                  <span className="stat-number">100%</span>
                  <span className="stat-label">
                    {t("adventure.stats.debugging")}
                  </span>
                </div>
                <div className="stat">
                  <span className="stat-number">∞</span>
                  <span className="stat-label">
                    {t("adventure.stats.possibilities")}
                  </span>
                </div>
              </div>
              ...
              >
                ...
                >
                  <span style={{ fontSize: "1.3rem", marginRight: "0.7rem" }}>
                    📄
                  </span>
                ...
                <button
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.linkedin.com/in/stefanyralvli/",
                      "_blank"
                    )
                  }
                  style={{
                ...
                <button
                  ...
                  onClick={() =>
                    window.open(
                      "https://github.com/stefanyralvgh/MyPortfolio",
                      "_blank"
                    )
                  }
                  style={{
        ...
        <>
          <div className="progress-bar" style={{ marginBottom: "1.5rem" }}>
            <div
              ...
              style={{
                width: `${(completedLevels.size / totalLevels) * 100}%`,
              }}
            ></div>
          </div>
          {currentLevelData && (
            <AdventureLevel
              level={{
                ...currentLevelData,
                titles:
                  typeof currentLevelData.titles === "string"
                    ? currentLevelData.titles
                    : currentLevelData.titles.en,
                descriptions:
                  typeof currentLevelData.descriptions === "string"
                    ? currentLevelData.descriptions
                    : currentLevelData.descriptions.en,
                question:
                  typeof currentLevelData.question === "string"
                    ? currentLevelData.question
                    : currentLevelData.question.en,
                explanation:
                  typeof currentLevelData.explanation === "string"
                    ? currentLevelData.explanation
                    : currentLevelData.explanation.en,
                options: {
                  A:
                    typeof currentLevelData.options.A === "string"
                      ? currentLevelData.options.A
                      : currentLevelData.options.A.en,
                  B:
                    typeof currentLevelData.options.B === "string"
                      ? currentLevelData.options.B
                      : currentLevelData.options.B.en,
                },
              }}
