...
const translations = {
  ...
  en: {
   'terminal.welcome': 'Hi! Welcome to Stef\'s adventure✨ This portfolio works like an interactive terminal.',
    ...
    'terminal.projects': 'View projects',
    'terminal.funfacts': 'Fun facts',
    'terminal.recruiter-mode': 'Fast track for recruiters',
