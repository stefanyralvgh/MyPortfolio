...
const translations = {
  es: {
    ...
    'terminal.recruiter-mode': 'Vía rápida para reclutadores ⏭️ – sin rodeos, solo lo esencial',
  ...
  fr: {
    ...
    'terminal.recruiter-mode': 'Voie rapide pour recruteurs ⏭️ – sans distractions, juste les faits',
    ...
    'terminal.skip.deprecated': 'La commande "skip" est obsolète. Essaie \'recruiter-mode\' à la place 😉\n',
